...
import { BG1, BG2, colorKappa, colorAA, colorAlfa, colorBetta, colorBettaLight, colorZeta, colorDelta } from '../Colors';
...
const OpenURLButton = ({ url, children }) => {
  ...
  return (
    <SafeAreaView style={{ flex: 1 }}>
      ...
      <LinearGradient colors={[colorAA, colorAlfa, colorBetta, colorBettaLight, colorAlfa]} style={styles.imageBackground}>
        <ScrollView>
            ...
            <View style={styles.wrap}>
              ...
              <View style={{ marginTop: 20, flexDirection: "row" }}>
                <TouchableOpacity onPress={() => setTerminosCondiciones(!TerminosCondiciones)} style={{ flexDirection: "row" }}>
                  {TerminosCondiciones
                    ? <Icon name="checkmark-square-2-outline" fill={colorAlfa} width={30} height={30} />
